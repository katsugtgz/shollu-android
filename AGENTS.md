...
└── app/
    ...
    └── src/
        ...
        │   ├── service/         # foreground services (FOREGROUND_SERVICE_TYPE_SPECIAL_USE): OngoingNotification, VibrationAlarm (45s auto-stop, 60s wakelock cap, silent _v2 channel — app waveform is the only haptic), FloatingDropzone (loop frozen while screen off)
